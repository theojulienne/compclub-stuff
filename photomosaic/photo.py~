...
resolution = 4 # The lower, the less subimages will be visible (down to 1)
pixelConversionFactor = 6  # Each pixel in super-image represents n pixels of a sub-image
